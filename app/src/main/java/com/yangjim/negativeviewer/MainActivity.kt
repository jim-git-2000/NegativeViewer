...
private fun NegativeViewerApp(cameraViewModel: CameraViewModel) {
    ...
    if (uiState.hasCameraPermission) {
        CameraScreen(
            ...
            onRedGainChange = cameraViewModel::setRedGain,
            onGreenGainChange = cameraViewModel::setGreenGain,
            onBlueGainChange = cameraViewModel::setBlueGain,
            onResetTone = cameraViewModel::resetTone,
            onResetRgb = cameraViewModel::resetRgbGain,
