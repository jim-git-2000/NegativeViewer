...
This repository is currently at the early MVP stage. It contains CI build setup, camera permission flow, a basic OpenGL preview surface, ImageCapture, MediaStore JPEG saving, RGB inversion for saved photos, and minimum EXIF orientation correction.
...
- Preview is currently an OpenGL shader placeholder, not live camera frames.
- CameraX still provides ImageCapture for saved photos.
