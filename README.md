...
This repository is currently at the early MVP stage. It contains CI build setup, camera permission flow, CameraX preview rendered through OpenGL, ImageCapture, MediaStore JPEG saving, RGB inversion for saved photos, and minimum EXIF orientation correction.
...
- Preview is currently live CameraX frames rendered by OpenGL, but real-time invert shader mode is not implemented yet.
